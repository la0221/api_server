"""v9.3 fix v2 — plus 84 crops from stable-area errors (M28-14 seam + M101-03).

Same code path as v1; only RUN_DIR differs and data_stable_crops now has
1785 crops (was 1701).
"""
...
RUN_DIR = HERE / "runs" / "nonar_v931_fix_v2"
HOLDOUT: list[str] = []
...
def main():
    ...
    log(f"[nonar v931-fix-v2] device={device} holdout={HOLDOUT}")
