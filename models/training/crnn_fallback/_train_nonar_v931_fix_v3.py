"""v9.3 fix v3 — plus 48 crops from v2's remaining errors (M17-07/M54-18/M83-03).

data_stable_crops now 1833 crops (was 1785).
"""
...
RUN_DIR = HERE / "runs" / "nonar_v931_fix_v3"
HOLDOUT: list[str] = []
...
def main():
    ...
    log(f"[nonar v931-fix-v3] device={device} holdout={HOLDOUT}")
